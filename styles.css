...
const fallbackCodes = [
  "USD", "EUR", "JPY", "HKD", "GBP", "AUD", "CAD", "CHF", "SGD", "THB",
  "VND", "TWD", "KES", "TZS", "UYU", "ARS", "CLP", "MOP", "MYR", "KRW",
  "AED", "SAR", "RUB", "ZAR", "MXN", "NZD", "BRL", "INR", "IDR", "PHP",
  "DKK", "SEK", "NOK", "PLN", "HUF", "TRY", "CZK", "RON", "ILS"
];
